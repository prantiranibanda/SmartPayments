  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-[calc(100vh-4.5rem)] bg-emerald-50">
      <div className="md:w-2/8 bg-white p-10 rounded border border-emerald-300 shadow-lg space-y-5">
        ...
        <div className="w-full space-y-3 text-lg font-light">
        ...
        <button
          onClick={onSignup}
          className="py-2 rounded font-bold text-white flex justify-center items-center bg-emerald-300 w-full hover:bg-emerald-400"
        >
          Sign up
        </button>
        <div className="text-sm font-light">
          Already have an account?{' '}
          <Link className="underline underline-offset-2 text-blue-400" href="/">
            Login
          </Link>
        </div>
      </div>
